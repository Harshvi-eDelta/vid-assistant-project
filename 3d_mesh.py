...
mesh_output_folder = "/Users/edelta076/Desktop/Project_VID_Assistant/new_dataset/generated_meshes"
...
for landmark_file in landmark_files:
    ...
    #  Fix: Ensure we have enough unique points
    if landmarks_3d.shape[0] < 4:
        print(f" Skipping {name}: Not enough valid 3D points for meshing.")
        continue

    #  Fix: Ensure points are not collinear or coplanar
    ...
    try:
        ...
        mesh = trimesh.Trimesh(vertices=unique_points, faces=faces)
...
mesh = trimesh.load_mesh("/Users/edelta076/Desktop/Project_VID_Assistant/new_dataset/generated_meshes/25.obj")
mesh.show()
